...
def main():
    ...
    train_path      = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/02_PB1/'
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/02_PB1/'   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/models_weight/02_PB1/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/part2/results/02_PB1/'
