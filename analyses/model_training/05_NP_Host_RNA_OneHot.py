...
def main():
    ...
    train_path      = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/05_NP/'
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/05_NP/'   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/models_weight/05_NP/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/part2/results/05_NP/'
