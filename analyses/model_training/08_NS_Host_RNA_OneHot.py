...
def main():
    ...
    train_path      = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/08_NS/'
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/08_NS/'   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/models_weight/08_NS/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/part2/results/08_NS/'
