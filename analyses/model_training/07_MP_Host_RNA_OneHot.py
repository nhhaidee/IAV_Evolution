...
def main():
    ...
    train_path      = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/07_MP/'
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/07_MP/'   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/models_weight/07_MP/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/part2/results/07_MP/'
