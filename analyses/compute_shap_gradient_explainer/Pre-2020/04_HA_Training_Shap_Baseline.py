...
def main():
    ...
    data_path   = "/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/data/04_HA"
    weight_path = "/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/models_weight/04_HA"
    shap_out    = "/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/part2/new/shap/04_HA/"
    segment     = "04_HA"
    unfold_size = 11
